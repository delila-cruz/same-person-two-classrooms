...
- [ ] **1. Write `scenes.js` — full data model + all narrative copy**
...
- [ ] **2. Build the core scene machine (`index.html`, `main.js`, `render.js`)**
...
- [ ] **3. Beat 1 — implement `staggeredNarration` scene type**
...
- [ ] **4. Build `lockedChoice.js` + wire Beat 2**
...
- [ ] **5. Climax setup + `multiRoundLockedChoice` drafting**
...
- [ ] **7. Styling pass — shared visual system**
...
- [ ] **8. Init git repo, push to GitHub, deploy to Vercel**
